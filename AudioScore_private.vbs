...
If serverRunning Then
    ' Serveur déjà en route → ouvrir en navigation privée (Chrome)
    WshShell.Run "chrome.exe --incognito http://localhost:5000"
Else
    ...
    ' ── Ouvrir le navigateur en navigation privée (Chrome) ────────────────────
    WshShell.Run "chrome.exe --incognito http://localhost:5000"
End If
